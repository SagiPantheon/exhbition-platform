...
export default function TentsLayoutPage() {
  ...
  const INVENTORY_ALL = [
    "שולחן", "במה לבנה", "דשבורד דיגיטלי",
    "במה כחולה", "במה קטנה", "כיסא מתקפל", "פודיום",
  ...
  const INVENTORY_FILTER_MAP: Record<string, string[]> = {
    "הכל":   [...INVENTORY_ALL],
    "ריהוט": ["שולחן", "כיסא מתקפל", "במה כחולה", "במה קטנה", "במה לבנה", "פודיום", "בסיס תצוגה קטן", "בסיס תצוגה בינוני", "בסיס תצוגה גדול"],
    "מדיה":  ["מסך", "דשבורד דיגיטלי", "רמקול", "לוגו לבן", "לוגו כחול גדול", "שילוט דיגיטלי", "שילוט מגנטי", "שילוט עץ", "לייטבוקס 2", "לייטבוקס 3 מטר", "קרוואן תצוגה"],
    "VIP":   ["פודיום"],
    "שירות": ["דשבורד דיגיטלי", "עמודי תור", "מתקן טלפונים", "דגל IAI", "דגל תעשייה אווירית", "רשת הסוואה", "שער מתנפח", "אוהל מתנפח", "אוהל לבן"],
  };
