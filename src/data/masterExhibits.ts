...
export const masterExhibits: MasterExhibit[] = [
  ...
  { slug: "inv-chair",      division: "inventory", nameEn: "Chair",       nameHe: "כיסא",   model3d: "/models/inventory/lightbox-horizontal-iai-01.glb", image: "", hasModel: true },
  ...
  { slug: "inv-stand",      division: "inventory", nameEn: "Stand",       nameHe: "דוכן",   model3d: "/models/inventory/lightbox-vertical-iai.glb",      image: "", hasModel: true },
  ...
  // New 19
  { slug: "inv-stage-blue",    division: "inventory", nameEn: "Blue Stage",      nameHe: "במה כחולה",     model3d: "/models/inventory/stage-blue-01.glb",              image: "", hasModel: true },
  { slug: "inv-screen",        division: "inventory", nameEn: "Screen Stand",    nameHe: "מסך",           model3d: "/models/inventory/screen-stand-iai-01.glb",        image: "", hasModel: true },
  ...
  { slug: "inv-loudspeaker",   division: "inventory", nameEn: "Speaker",         nameHe: "רמקול",         model3d: "/models/inventory/loudspeaker-iai.glb",            image: "", hasModel: true },
  { slug: "inv-folding-chair", division: "inventory", nameEn: "Folding Chair",   nameHe: "כיסא מתקפל",    model3d: "/models/inventory/folding-chair-iai.glb",          image: "", hasModel: true },
  ...
  { slug: "inv-camo",          division: "inventory", nameEn: "Camo Net",        nameHe: "רשת הסוואה",    model3d: "/models/inventory/camouflage-iai-01.glb",          image: "", hasModel: true },
  ...
  { slug: "inv-queue-poles",   division: "inventory", nameEn: "Queue Poles",     nameHe: "עמודי תור",     model3d: "/models/inventory/queue-poles-01.glb",             image: "", hasModel: true },
  { slug: "inv-phone-storage", division: "inventory", nameEn: "Phone Storage",   nameHe: "מתקן טלפונים",  model3d: "/models/inventory/phone-storage-01.glb",           image: "", hasModel: true },
  { slug: "inv-stage-small",   division: "inventory", nameEn: "Small Stage",     nameHe: "במה קטנה",      model3d: "/models/inventory/stage-blue-1m-01.glb",           image: "", hasModel: true },
  ...
  { slug: "inv-inflatable-tent",division: "inventory",nameEn: "Inflatable Tent", nameHe: "אוהל מתנפח",    model3d: "/models/inventory/inflatable-tent-01.glb",         image: "", hasModel: true },
  { slug: "inv-lightbox2",     division: "inventory", nameEn: "Lightbox 2",      nameHe: "לייטבוקס 2",    model3d: "/models/inventory/ligthbox-horizontal-iai-02.glb", image: "", hasModel: true },
  { slug: "inv-podium",        division: "inventory", nameEn: "Podium",          nameHe: "פודיום",        model3d: "/models/inventory/acrylic-podium-iai.glb",         image: "", hasModel: true },
  { slug: "inv-digital-sign",  division: "inventory", nameEn: "Digital Signage", nameHe: "שילוט דיגיטלי", model3d: "/models/inventory/digital-signage-01.glb",         image: "", hasModel: true },
  { slug: "inv-magnetic-sign", division: "inventory", nameEn: "Magnetic Signage",nameHe: "שילוט מגנטי",   model3d: "/models/inventory/magnetic-signage-01.glb",        image: "", hasModel: true },
  { slug: "inv-logo-blue",     division: "inventory", nameEn: "Large Blue Logo", nameHe: "לוגו כחול גדול",model3d: "/models/inventory/logo-blue-large-01.glb",         image: "", hasModel: true },
  { slug: "inv-white-tent",    division: "inventory", nameEn: "White Tent",      nameHe: "אוהל לבן",      model3d: "/models/inventory/tent-white-01.glb",              image: "", hasModel: true },
];
