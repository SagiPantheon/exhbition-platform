...
export const masterExhibits: MasterExhibit[] = [
  ...
  // ── NEW EXHIBITS (6) — added 24.06.2026, all MATAH/tilim ──────────────────
  {
    slug: "mss", division: "mtach", subdivision: "tilim", nameEn: "MSS", nameHe: "ספינה",
    model3d: "/models/air/mss-showcase-3d.glb", image: "/images/air/mss-showcase.png", hasModel: true,
    code: "AR-NEW-001",
    subtitle: { en: "Naval destroyer scale model for premium exhibition presentation.", he: "דגם משחתת ים לתצוגת פרימיום בתערוכה." },
    description: { en: "Prepared for premium naval exhibition display and operational maritime presentation.", he: "מוכן לתצוגת תערוכה ימית פרימיום והצגה מבצעית." },
    status: { en: "Approved", he: "מאושר" }, config: { en: "Ship display", he: "תצוגת ספינה" }, scale: "1:100",
    specs: { length: "TBD", width: "TBD", height: "TBD", weight: "TBD", standDiameter: "N/A", standWeight: "N/A" },
    readiness: { environment: { en: "Indoor / Outdoor", he: "פנים / חוץ" }, displayMethod: { en: "Static display", he: "תצוגה סטטית" }, support: { en: "Self-standing", he: "עצמאי" }, presentationLevel: { en: "Premium", he: "פרימיום" }, visualLanguage: { en: "Naval showcase", he: "תצוגה ימית" } },
  },
  {
    slug: "barak-missile", division: "mtach", subdivision: "tilim", nameEn: "Barak Missile", nameHe: "טיל ברק",
    model3d: "/models/air/barak-missile-showcase-3d.glb", image: "/images/air/barak-missile-showcase.png", hasModel: true,
    code: "AR-NEW-002",
    subtitle: { en: "Air-defense interceptor missile for premium exhibition presentation.", he: "טיל יירוט להגנת אויר לתצוגת פרימיום." },
    description: { en: "Prepared for premium missile exhibition display and operational air-defense presentation.", he: "מוכן לתצוגת טיל פרימיום והצגה מבצעית." },
    status: { en: "Approved", he: "מאושר" }, config: { en: "Missile display", he: "תצוגת טיל" }, scale: "1:1",
    specs: { length: "TBD", width: "TBD", height: "TBD", weight: "TBD", standDiameter: "N/A", standWeight: "N/A" },
    readiness: { environment: { en: "Indoor / Outdoor", he: "פנים / חוץ" }, displayMethod: { en: "Static display", he: "תצוגה סטטית" }, support: { en: "Self-standing", he: "עצמאי" }, presentationLevel: { en: "Premium", he: "פרימיום" }, visualLanguage: { en: "Missile showcase", he: "תצוגת טיל" } },
  },
  {
    slug: "lora-launcher", division: "mtach", subdivision: "tilim", nameEn: "LORA Launcher", nameHe: "משגר לורה",
    model3d: "/models/air/lora-launcher-showcase-3d.glb", image: "/images/air/lora-launcher-showcase.png", hasModel: true,
    code: "AR-NEW-003",
    subtitle: { en: "Long-range artillery launcher for premium exhibition presentation.", he: "משגר ארטילרי לטווח ארוך לתצוגת פרימיום." },
    description: { en: "Prepared for premium launcher exhibition display and operational presentation.", he: "מוכן לתצוגת משגר פרימיום והצגה מבצעית." },
    status: { en: "Approved", he: "מאושר" }, config: { en: "Launcher display", he: "תצוגת משגר" }, scale: "1:1",
    specs: { length: "TBD", width: "TBD", height: "TBD", weight: "TBD", standDiameter: "N/A", standWeight: "N/A" },
    readiness: { environment: { en: "Indoor / Outdoor", he: "פנים / חוץ" }, displayMethod: { en: "Static display", he: "תצוגה סטטית" }, support: { en: "Self-standing", he: "עצמאי" }, presentationLevel: { en: "Premium", he: "פרימיום" }, visualLanguage: { en: "Launcher showcase", he: "תצוגת משגר" } },
  },
  {
    slug: "sultan", division: "mtach", subdivision: "tilim", nameEn: "Sultan", nameHe: "סולטן",
    model3d: "/models/air/sultan-showcase-3d.glb", image: "/images/air/sultan-showcase.png", hasModel: true,
    code: "AR-NEW-004",
    subtitle: { en: "Aerial platform for premium exhibition presentation.", he: "פלטפורמה אווירית לתצוגת פרימיום." },
    description: { en: "Prepared for premium aerial exhibition display and operational presentation.", he: "מוכן לתצוגת תערוכה אווירית פרימיום והצגה מבצעית." },
    status: { en: "Approved", he: "מאושר" }, config: { en: "Aircraft display", he: "תצוגת מטוס" }, scale: "1:1",
    specs: { length: "TBD", width: "TBD", height: "TBD", weight: "TBD", standDiameter: "N/A", standWeight: "N/A" },
    readiness: { environment: { en: "Indoor / Outdoor", he: "פנים / חוץ" }, displayMethod: { en: "Static display", he: "תצוגה סטטית" }, support: { en: "Self-standing", he: "עצמאי" }, presentationLevel: { en: "Premium", he: "פרימיום" }, visualLanguage: { en: "Aircraft showcase", he: "תצוגת מטוס" } },
  },
  {
    slug: "container", division: "mtach", subdivision: "tilim", nameEn: "Control Cabin", nameHe: "קרון שליטה",
    model3d: "/models/air/container-showcase-3d.glb", image: "/images/air/container-showcase.png", hasModel: true,
    code: "AR-NEW-005",
    subtitle: { en: "Barak system control cabin for premium exhibition presentation.", he: "קרון שליטה של מערכת ברק לתצוגת פרימיום." },
    description: { en: "Prepared for premium command-and-control exhibition display and operational presentation.", he: "מוכן לתצוגת שליטה ובקרה פרימיום והצגה מבצעית." },
    status: { en: "Approved", he: "מאושר" }, config: { en: "Cabin display", he: "תצוגת קרון" }, scale: "1:1",
    specs: { length: "TBD", width: "TBD", height: "TBD", weight: "TBD", standDiameter: "N/A", standWeight: "N/A" },
    readiness: { environment: { en: "Indoor / Outdoor", he: "פנים / חוץ" }, displayMethod: { en: "Static display", he: "תצוגה סטטית" }, support: { en: "Self-standing", he: "עצמאי" }, presentationLevel: { en: "Premium", he: "פרימיום" }, visualLanguage: { en: "C2 showcase", he: "תצוגת שליטה" } },
  },
  {
    slug: "mini-harpy-launcher", division: "mtach", subdivision: "tilim", nameEn: "Mini Harpy Launcher", nameHe: "משגר מיני הרפי",
    model3d: "/models/air/mini-harpy-launcher-showcase-3d.glb", image: "/images/air/mini-harpy-launcher-showcase.png", hasModel: true,
    code: "AR-NEW-006",
    subtitle: { en: "Loitering-munition launcher for premium exhibition presentation.", he: "משגר תחמושת מתהוגגת לתצוגת פרימיום." },
    description: { en: "Prepared for premium launcher exhibition display and operational strike presentation.", he: "מוכן לתצוגת משגר פרימיום והצגה מבצעית." },
    status: { en: "Approved", he: "מאושר" }, config: { en: "Launcher display", he: "תצוגת משגר" }, scale: "1:1",
    specs: { length: "TBD", width: "TBD", height: "TBD", weight: "TBD", standDiameter: "N/A", standWeight: "N/A" },
    readiness: { environment: { en: "Indoor / Outdoor", he: "פנים / חוץ" }, displayMethod: { en: "Static display", he: "תצוגה סטטית" }, support: { en: "Self-standing", he: "עצמאי" }, presentationLevel: { en: "Premium", he: "פרימיום" }, visualLanguage: { en: "Launcher showcase", he: "תצוגת משגר" } },
  },
